...
$modPathIcon16   = \TESTIMONIAL_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = \TESTIMONIAL_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
$style = \TESTIMONIAL_URL . '/assets/css/admin/style.css';
