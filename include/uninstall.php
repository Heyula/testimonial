 ...
 */
function xoops_module_pre_uninstall_testimonial(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_testimonial(\XoopsModule $module)
{
    ...
    if (is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_TESTIMONIAL_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
