 ...
 * @return bool|null
 */
function xoops_module_update_testimonial($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_testimonial_v10($module);
    }

    $ret = testimonial_check_db($module);

    //check upload directory
    require_once __DIR__ . '/install.php';
    $ret = xoops_module_install_testimonial($module);
 ...
 * @return bool
 */
function update_testimonial_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function testimonial_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('testimonial_images');
    $field   = 'img_exif';
